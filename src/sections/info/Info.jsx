            ...
            <div className="info container">
                <div className="info__wrapper container">
                    ...
                    <div className={infoTextTwo}>
                        <p>
                        Полтора года назад я погрузилась в мир веб-разработки. Теперь мой каждый день состоит из постоянного изучения инструментов программирования (кажется это нескончаемый процесс), research и VScode. Обучаюсь самостоятельно и с помощью добрых людей :) Умею и люблю работать в команде. 
                        </p>
                    </div>
